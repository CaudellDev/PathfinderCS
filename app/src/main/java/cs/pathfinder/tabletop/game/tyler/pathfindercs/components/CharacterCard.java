package cs.pathfinder.tabletop.game.tyler.pathfindercs.components;
...
public class CharacterCard extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.CharacterCard, defStyle, 0);

        mExampleString = a.getString(
                R.styleable.CharacterCard_exampleString);
        mExampleColor = a.getColor(
                R.styleable.CharacterCard_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.CharacterCard_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.CharacterCard_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.CharacterCard_exampleDrawable);
